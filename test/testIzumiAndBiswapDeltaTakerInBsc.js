...
describe("izumi and biswap taker test using self deploying taker contract", function () {
  ...
  it("Should show izumiAndBiswapDeltaTaker taker result", async function () {
    ...
    let izumiAndBiswapDeltaQuoterAddress = '0xdf5F72085Deb8533692f44C6E0027fCF4ef7bf04'
    izumiAndBiswapDeltaQuoter = await ethers.getContractAt(izumiAndBiswapDeltaQuoterAbi, izumiAndBiswapDeltaQuoterAddress)

    // load izumiAndBiswap taker
    let izumiAndBiswapDeltaTakerAbi = getAbi('IzumiAndBiswapDeltaTaker')
    let izumiAndBiswapDeltaTakerAddress = '0x1Af7c73a9cEa033c202dc27aD891497D2E887fD2'
    izumiAndBiswapDeltaTaker = await ethers.getContractAt(izumiAndBiswapDeltaTakerAbi, izumiAndBiswapDeltaTakerAddress)
    ...
    for (var index = 0; index < 1; index++) {
      ...
      for (var path of pathList) {
        ...
        let amountInAList = [10 + index * 0.01]
