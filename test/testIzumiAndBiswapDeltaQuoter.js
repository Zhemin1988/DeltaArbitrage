...
describe("izumi and biswap delta quoter test using self deploying quoter contract", function () {
  ...
  it("Should show izumiAndBiswapDeltaQuoter quoter result", async function () {
    ...
    const IzumiAndBiswapDeltaFactory = await hre.ethers.getContractFactory('IzumiAndBiswapDeltaQuoter');
    izumiAndBiswapDeltaQuoter = await IzumiAndBiswapDeltaFactory.deploy(izumiProxyAddress, biswapProxyAddress);
